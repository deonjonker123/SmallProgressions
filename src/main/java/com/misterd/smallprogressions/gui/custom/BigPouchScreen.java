...
public class BigPouchScreen extends AbstractContainerScreen<BigPouchMenu> {
    ...
    public BigPouchScreen(BigPouchMenu menu, Inventory playerInventory, Component title) {
