...
public class SPButton extends Button {
    ...
    protected static final WidgetSprites SPRITES = new WidgetSprites(
            Identifier.fromNamespaceAndPath("smallprogressions", "button"),
            Identifier.fromNamespaceAndPath("smallprogressions", "button_disabled"),
            Identifier.fromNamespaceAndPath("smallprogressions", "button_highlighted")
    );

    public SPButton(int x, int y, int width, int height, Component label, OnPress onPress) {
