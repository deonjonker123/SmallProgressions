...
public class WirelessRedstoneTransmitterScreen extends AbstractContainerScreen<WirelessRedstoneTransmitterMenu> {
    ...
    public WirelessRedstoneTransmitterScreen(WirelessRedstoneTransmitterMenu menu, Inventory inventory, Component title) {
    ...
    protected void init() {
        ...
        channelBox = new EditBox(font, leftPos + EB_X, topPos + EB_Y, EB_W, EB_H, Component.translatable("gui.smallprogressions.transmitter.channel_box"));
        ...
        Component resetLabel = Component.translatable("gui.smallprogressions.transmitter.reset");
        Component setLabel = Component.translatable("gui.smallprogressions.transmitter.set");
        Component cancelLabel = Component.translatable("gui.smallprogressions.transmitter.cancel");
    ...
    protected void extractTooltip(GuiGraphicsExtractor gfx, int mouseX, int mouseY) {
        if (channelBox != null && channelBox.isHoveredOrFocused()) {
            gfx.setTooltipForNextFrame(font, Component.translatable("gui.smallprogressions.transmitter.channel_box.tooltip.line1").withStyle(ChatFormatting.GOLD), mouseX, mouseY);
        }
